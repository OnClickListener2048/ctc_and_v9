...
public class AccountShuoMingActivity extends MyBaseActivity {
    ...
    private void init() {
        ...
        fragment_share_title_text.setText("账户说明");
        ...
        if (Tools.getAPNType(AccountShuoMingActivity.this) == true){
    ...
    {
        //mZProgressHUD.show();
        HttpConnect.post(this, "member_money_count_intruce", null, new Callback() {
            @Override
