...
public class ActiveExplainActivity extends MyBaseActivity {
	...
	private void init() {
		...
		fragment_share_title_text.setText("活跃说明");
		tv_target_more.setText("我要点赞>>");
		...
		tv_target_more.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				startActivity(new Intent(ActiveExplainActivity.this,ContactListActivity.class));
				finish();
			}
		});
		getUrl();
	...
	{
		//mZProgressHUD.show();
		HttpConnect.post(this, "member_mining_active", null, new Callback() {
			@Override
