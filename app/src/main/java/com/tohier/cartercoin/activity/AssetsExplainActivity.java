...
public class AssetsExplainActivity extends MyBaseActivity {
	...
	private void init() {
		...
		fragment_share_title_text.setText("矿产包详细说明");
	...
	{
		//mZProgressHUD.show();
		HttpConnect.post(this, "member_assets_introduce_detail", null, new Callback() {
			@Override
