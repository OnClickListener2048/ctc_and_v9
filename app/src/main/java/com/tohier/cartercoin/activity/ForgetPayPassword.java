...
public class ForgetPayPassword extends MyBackBaseActivity {
...
//        }
    ...
    private void confirmFindLoginPwd()
    {
        ...
        HttpConnect.post(this, "member_modify_passwordpay_byname", par, new Callback() {
...
//
    ...
    public void onValidateCode() {
        ...
        if (StringUtils.isNotBlank(phone) && NumberUtils.isNumber(phone) && phone.length() == 11) {
            ...
            par.put("code","member_modify_passwordpay_byname");
