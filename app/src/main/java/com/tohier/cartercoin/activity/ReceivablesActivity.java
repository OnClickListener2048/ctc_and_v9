...
public class ReceivablesActivity extends MyBackBaseActivity {

    private ImageView ivBack,iv_member_level_icon,iv_bill_erweima;
    private TextView tvBill,tv_member_level_msg,tv_member_name;
    private LinearLayout linearLayout_into_capture;
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
           switch (v.getId())
           {
               ...
               case R.id.tv_bill:
                      startActivity(new Intent(ReceivablesActivity.this,BillListActivity.class));
                   break;

               case R.id.linearLayout_into_capture:
                   startActivityForResult(new Intent(ReceivablesActivity.this, CaptureActivity.class), 0);
                   break;
           }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receivables_layout);
...
//        iSlider.setConfig(mConfig);
    ...
    public void initData() {
        ...
        tvBill = (TextView) this.findViewById(R.id.tv_bill);
    ...
    private void setUpView() {
        ...
        tvBill.setOnClickListener(onClickListener);
        linearLayout_into_capture.setOnClickListener(onClickListener);
    }
                ...
                if (data.get("status").equals("success"))
                {
                        Handler dataHandler = new Handler(
                                    ...
                                    final Message msg)
                            {
                                ...
                                Intent intent = new Intent(ReceivablesActivity.this,PayMoneyActivity.class);
