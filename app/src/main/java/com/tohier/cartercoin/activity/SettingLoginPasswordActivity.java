...
public class SettingLoginPasswordActivity extends MyBackBaseActivity{
        ...
        btn_commit_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else
                {
                    ...
                    HttpConnect.post(SettingLoginPasswordActivity.this, "member_set_password", par, new Callback() {
