...
public class UpgradeMemberExplainActivity extends MyBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		p.height = (int) (d.getHeight() * 0.40);   //高度设置为屏幕的1.0
	...
	private void init() {
		...
		fragment_share_title_text.setText("VIP说明");
		tv_target_more.setText("升级尊贵身份>>");
		...
		tv_target_more.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				tv_target_more.setClickable(false);
					HttpConnect.post(UpgradeMemberExplainActivity.this, "member_buy_upgrade_count", null, new Callback() {
						@Override
						public void onResponse(Response arg0) throws IOException {
							...
							if (data.optString("status").equals("success")){
								...
								runOnUiThread(new Runnable() {
									...
									public void run() {
										...
										Intent intent = new Intent(UpgradeMemberExplainActivity.this, VipUpgradeActivity.class);
							...
							}else
							{
								runOnUiThread(new Runnable() {
									@Override
									public void run() {
										tv_target_more.setClickable(true);
									}
								});
							}
						}
	...
	{
		//mZProgressHUD.show();
		HttpConnect.post(this, "member_mining_grade", null, new Callback() {
			@Override
			public void onResponse(Response arg0) throws IOException {
