...
public class UpgradeRecordActivity extends MyBackBaseActivity {
    ...
    private void init() {
        ...
        adapter = new UpgradeRecordAdapter(this,list,2,getIntent().getStringExtra("type"),ivBack);
        lvUpgradeReCord.setAdapter(adapter);

        wxPaySuccessReceiver = new WXPaySuccessReceiver("会员升级");
        ...
        ivNoLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Tools.getAPNType(UpgradeRecordActivity.this) == true){
    ...
    private void getData() {
        ...
        HttpConnect.post(this, "member_upgrade_list", null, new Callback() {
            @Override
