...
public class VipListExplainActivity extends MyBaseActivity {
	...
	private void init() {
		...
		fragment_share_title_text.setText("挖矿等级说明");
		...
		if (Tools.getAPNType(VipListExplainActivity.this) == true){
	...
	{
		//mZProgressHUD.show();
		HttpConnect.post(this, "member_mining_member_grade", null, new Callback() {
			@Override
