...
import com.tohier.cartercoin.activity.CaptureActivity;
import com.tohier.cartercoin.activity.ContactListActivity;
import com.tohier.cartercoin.activity.MyQrCode;
...
import static com.tohier.cartercoin.activity.ConversationActivity.activity;
...
//                                activity.sToast("链接超时！");
    ...
    public View getCustomItemView(Fragment fragment, YWConversation conversation, View convertView, int viewType, YWContactHeadLoadHelper headLoadHelper, ViewGroup parent) {
        ...
        userid = LoginUser.getInstantiation(fragment.getActivity().getApplicationContext()).getLoginUser().getLinkCode();
