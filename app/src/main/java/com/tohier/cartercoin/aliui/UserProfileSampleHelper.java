...
import com.tohier.cartercoin.activity.MeInfoActivity;
...
public class UserProfileSampleHelper {
    ...
    public static void initProfileCallback(Context context) {
        ...
        userid = LoginUser.getInstantiation(context.getApplicationContext()).getLoginUser().getLinkCode();
        imKit = YWAPI.getIMKitInstance(userid, MyApplication.APP_KEY);
        if(imKit == null) {
            return;
        }
