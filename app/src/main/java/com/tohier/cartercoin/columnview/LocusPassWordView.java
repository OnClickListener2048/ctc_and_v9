...
import com.tohier.cartercoin.gesturespasswordconfig.MathUtil;
import com.tohier.cartercoin.gesturespasswordconfig.Point;
...
public class LocusPassWordView extends View {
	...
	private int errorColor = 0xffff2525;
	private int selectedColor = 0xfff7bd2b;
	private int outterSelectedColor = 0xfff7bd2b;
	private int outterErrorColor = 0xffff2525;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (isFinish) {
			if (this.sPoints.size() == 1) {
				...
				error();
				clearPassword();
				Toast.makeText(this.getContext(), "不能少于4位!",
