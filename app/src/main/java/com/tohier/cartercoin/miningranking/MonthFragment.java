...
public class MonthFragment extends BaseFragment implements LoadMiningRankingListDataView {
    private View view;
    ...
    public void initData() {
        loadMiningRankingListDataPresenter = new LoadMiningRankingListDataPresenter(getActivity(),this,"month");
