...
public class WeekFragment extends BaseFragment implements LoadMiningRankingListDataView{
    private View view;
    ...
    public void initData() {
        loadMiningRankingListDataPresenter = new LoadMiningRankingListDataPresenter(getActivity(),this,"week");
