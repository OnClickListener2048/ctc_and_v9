...
public class ShareOptionIntegralRankingFragment extends BaseFragment implements ShareOptionRankingView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view =  inflater.inflate(R.layout.fragment_integral_ranking,container,false);
    ...
    private void init() {
        lvIntegral = (ListView) view.findViewById(R.id.lv_integral);
        ivNodata = (NoDataView) view.findViewById(R.id.iv_nodata);
        gifLoading = (LoadingView) view.findViewById(R.id.cif_loading);

        adapter = new ShareOptionRankingAdapter(getActivity(),list,0);
        lvIntegral.setAdapter(adapter);

        gifLoading.setVisibility(View.VISIBLE);
        presenter = new ShareOptionRankingPresenter((MyBaseFragmentActivity)getActivity(),this);
        presenter.getRanking(code);
    }
